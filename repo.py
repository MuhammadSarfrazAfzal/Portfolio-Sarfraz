...
repos_list = [
    ...
    "PtPrashantTripathi/php-social-networking-site","MuhammadSarfrazAfzal/Weather-app",
    "MuhammadSarfrazAfzal/Url-Shortening-landingpage","MuhammadSarfrazAfzal/Singleprice-grid-component",
    "MuhammadSarfrazAfzal/Product-landingpage"
]
